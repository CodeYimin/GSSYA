...
export const englishWebsiteData: WebsiteData = {
  navbar: {
    links: [
      {
        label: "About",
  ...
  questions: {
    ...
    questions: [
      {
        question:
          "Will the tutors have a volunteer hour certificate and a letter of recommendation?",
        answer: "GSSYA provides both written proof and recommendation letters.",
      },
      {
        question: "How can I become a volunteer?",
        answer:
          "Applicants need to submit a written application. After contacting the recommender and conducting an interview (including video interview), the qualified person can become a tutor. Adult applicants require a criminal background check.",
      },
      {
        question: "Is there a fee for being a volunteer?",
        answer: "No, GSSYA is 100% free.",
      },
      {
        question: "Is GSSYA completely free?",
        answer:
          "Yes, GSSYA is 100% free and the services are provided by volunteers.",
      },
      {
