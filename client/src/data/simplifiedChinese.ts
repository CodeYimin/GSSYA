...
export const simplifiedChineseWebsiteData: WebsiteData = {
  navbar: {
    links: [
      {
        label: "关于",
  ...
  programs: {
    ...
    programs: [
      ...
      },
      {
        title: "俱乐部",
        description:
          "在我们的艺术、舞蹈、国际象棋、辩论和歌剧俱乐部庆祝多样性。加入我们参加包容性活动、获得志愿者时间并分享文化体验。",
        buttons: [
          {
            label: "了解更多",
      ...
      },
      {
        title: "青年交换",
        description:
          "青年交换项目为年轻人提供探索新文化、建立国际友谊并通过沉浸式跨文化体验拓宽世界视野的机会。",
        buttons: [
          {
            label: "了解更多",
  ...
  questions: {
    ...
    questions: [
      {
        question: "辅导老师是否有志愿者时數证书和推荐信？",
        answer: "GSSYA 會提供书面证明和推荐信。",
      },
      {
        question: "我如何成为志愿者？",
        answer:
          "申请人需要提交书面申请。联系推荐人并进行面试（包括视频面试）后，符合条件的人可以成为辅导老师。成人申请者需要接受犯罪背景调查。",
      },
      {
        question: "成为志愿者需要付费吗？",
        answer: "不，GSSSYA 是 100% 免费的。",
      },
      {
        question: "GSSYA 是非牟利的吗？",
        answer: "是的，GSSSA 是 100% 非牟利的，服务由志愿者提供。",
      },
      {
        question: "我可以在线申请吗？",
        answer:
          "是的，您可以瀏覽网站 ssytutor.org、微信公众号或发送电子邮件至 ssytutor@gmail.com。",
      },
    ],
  },
  donate: {
