  ...
  return (
    <div id="home" className="flex justify-between">
      <div className="text-black">
        <p className="text-xl z-50">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sed magnam, recusandae velit a est modi natus quisquam ratione quia esse, exercitationem molestias? Libero voluptate dicta temporibus nobis sed. Dolorum, odio.</p>
      </div>
