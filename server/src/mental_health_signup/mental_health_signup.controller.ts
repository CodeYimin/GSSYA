...
export class MentalHealthSignupController {
  ...
  async getComplete(
    ...
    const res = await api.sendMessage(
      `This is a mental health questionaire. Give feedback and advice to someone who responded in a mental health questionnaire with an overall mental health score of ${score}/${scoreMax} with higher being the best mental health. Do NOT ask a question. Do NOT comment on if the user was honest or not. Tell the user the score in the response.`,
    );
